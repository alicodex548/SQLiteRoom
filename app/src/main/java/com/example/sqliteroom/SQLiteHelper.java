...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            db.execSQL("CREATE TABLE " + TABLE_TASK + " (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT,completed BOOLEAN)");
    ...
    public int updateTask(Task task) {
        ...
        contentValues.put("title", task.getTitle());
        contentValues.put("completed", task.isCompleted());
        int result = sqLiteDatabase.update(TABLE_TASK, contentValues, "id = ?", new String[]{String.valueOf(task.getId())});
        sqLiteDatabase.close();
        return result;
    }
